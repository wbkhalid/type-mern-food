                ...
                <div className="flex-1">
                    ...
                    <div className="flex flex-col gap-3 md:flex-row md:items-center my-3">
                        ...
                        <div className="flex flex-wrap gap-2 mb-2">
                            {['Biryani', 'Jilabi', "Momoos"]?.map((selectedFilter: string, index: number) => (
                                <div key={index} className="relative inline-flex items-center max-w-full">
                                    <Badge className="text-[#D19452] rounded-md cursor-pointer pr-6 whitespace-nowrap" variant='outline'>{selectedFilter}</Badge>
                                    <X size={16} className="absolute text-[#D19452] right-1 cursor-pointer" />
                                </div>
                            ))}
                        </div>
                    </div>
                                ...
                                >
                                    ...
                                    <CardContent className="p-4">
                                        ...
                                        <div className="mt-2 gap-1 flex items-center text-gray-600 dark:text-gray-400">
                                            ...
                                            <p className="text-sm">
                                                City:{" "}
                                                <span className="font-medium">Sargodha</span>
                                            </p>
                                        </div>
                                        <div className="mt-2 gap-1 flex items-center text-gray-600 dark:text-gray-400">
                                            <Globe size={16} />
